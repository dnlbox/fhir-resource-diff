...
| 27 | `27-documentation-site.md` | VitePress docs site deployed to GitHub Pages | ✓ complete |
...
| 31 | `31-normalize-improvements.md` | normalize: stats, --summary flag, preset descriptions, help text | ✓ complete |
